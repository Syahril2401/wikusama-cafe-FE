...
const Transaksi = () => {
    ...
    const { toPDF, targetRef } = usePDF({ filename: "invoice.pdf", canvas: { qualityRatio: 1 }, resolution: Resolution.HIGH, page: { margin: Margin.MEDIUM, format: "letter" } })
    ...
    /** ecah detail contain id_menu dan jumlah */
    ...
    const addMenu = () => {
        ...
        /** ... = mengambil semua key dari objek detail_transaksi kemudian di jumlah */
    ...
    return (
        <div className="w-100 p-0">
            ...
            <div ref={targetRef} style={{ display: showNota ? 'block' : 'none' }}>
                <div className="w-100">
                    <h1 className="text-center">Wikusama Cafe</h1>
                    <h6 className="text-center">Jl. Jembawan VI/3E No.36</h6>
